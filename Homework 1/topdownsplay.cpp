...
class SplayTree{
    public:
		...
		Tree_node *result = k2->lchild;
		k2->lchild = result->rchild;
		result->rchild = k2;
		return result;
		...
		Tree_node* result = k2->rchild;
		k2->rchild = result->lchild;
		result->lchild = k2;
		return result;
        }
        ...
        // check if root exists or if key is in the root
           if (root == NULL)
           {
               return NULL;
           }
